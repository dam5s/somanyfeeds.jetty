...
////////////  PROGRAMS  ////////////
    ...
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$selectedClass = function (feed) {
        return feed.selected ? 'selected' : 'not';
    };
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$feedLink = F2(
        function (feeds, feed) {
            return A2(
                ...
                A2(
                    ...
                    A2(
                        ...
                        function (f) {
                            return _elm_lang$core$Native_Utils.eq(f.slug, feed.slug) ? (f.selected ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(f.slug)) : (f.selected ? _elm_lang$core$Maybe$Just(f.slug) : _elm_lang$core$Maybe$Nothing);
                        },
                        feeds)));
        });
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$listItem = F2(
        function (feeds, feed) {
            return A2(
                ...
                _elm_lang$core$Native_List.fromArray(
                    [
                        _elm_lang$html$Html_Attributes$class(
                            _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$selectedClass(feed))
                    ]),
                _elm_lang$core$Native_List.fromArray(
                    [
                        A2(
                            ...
                            _elm_lang$core$Native_List.fromArray(
                                [
                                    _elm_lang$html$Html_Attributes$href(
                                        A2(_dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$feedLink, feeds, feed))
                                ]),
                            _elm_lang$core$Native_List.fromArray(
                                [
                                    _elm_lang$html$Html$text(feed.name)
                                ]))
                    ]));
        });
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$view = function (feeds) {
        return A2(
            ...
            A2(
                _elm_lang$core$List$map,
                _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$listItem(feeds),
                feeds));
    };
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$selectedSources = function (feeds) {
        return A2(
            _elm_lang$core$List$map,
            function (f) {
                return f.slug;
    ...
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$defaultFeeds = _elm_lang$core$Native_List.fromArray(
        [
    ...
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$selectFeeds = function (sources) {
        var sourceList = A2(_elm_lang$core$String$split, ',', sources);
        return A2(
            _elm_lang$core$List$map,
            function (f) {
                return _elm_lang$core$Native_Utils.update(
                    f,
                    {
                        selected: A2(_elm_lang$core$List$member, f.slug, sourceList)
                    });
            },
            _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$defaultFeeds);
    };
    var _dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$Feed = F3(
        function (a, b, c) {
            return {name: a, slug: b, selected: c};
        });
    ...
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$blog = {name: 'Blog', slug: 'blog', selected: false};
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$twitter = {
        name: 'Twitter',
        slug: 'twitter',
        selected: true
    };
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$about = {name: 'About', slug: 'about', selected: true};
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$someFeeds = _elm_lang$core$Native_List.fromArray(
        [_dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$about, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$twitter, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$blog]);
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$tests = A2(
        ...
        _elm_lang$core$Native_List.fromArray(
            [
                A2(
                    ...
                    'feedLink when feed not selected',
                    A2(
                        _elm_community$elm_test$ElmTest$assertEqual,
                        A2(_dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$feedLink, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$someFeeds, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$blog),
                        '#about,twitter,blog')),
                A2(
                    _elm_community$elm_test$ElmTest$test,
                    'feedLink when feed is selected',
                    A2(
                        _elm_community$elm_test$ElmTest$assertEqual,
                        A2(_dam5s$somanyfeeds_boot$SoManyFeeds_Feeds$feedLink, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$someFeeds, _dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$about),
                        '#twitter,foo'))
            ]));

    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_Tests$fullSuite = A2(
        _elm_community$elm_test$ElmTest$suite,
        'SoManyFeeds',
        _elm_lang$core$Native_List.fromArray(
            [_dam5s$somanyfeeds_boot$SoManyFeedsTests_FeedsTests$tests]));
    var _dam5s$somanyfeeds_boot$SoManyFeedsTests_Tests$main = {
        main: _elm_community$elm_test$ElmTest$runSuite(_dam5s$somanyfeeds_boot$SoManyFeedsTests_Tests$fullSuite)
    };

    var Elm = {};
    Elm['SoManyFeedsTests'] = Elm['SoManyFeedsTests'] || {};
    Elm['SoManyFeedsTests']['Tests'] = Elm['SoManyFeedsTests']['Tests'] || {};
    _elm_lang$core$Native_Platform.addPublicModule(Elm['SoManyFeedsTests']['Tests'], 'SoManyFeedsTests.Tests', typeof _dam5s$somanyfeeds_boot$SoManyFeedsTests_Tests$main === 'undefined' ? null : _dam5s$somanyfeeds_boot$SoManyFeedsTests_Tests$main);
