...
class CloudFoundryConfigurationFactoryFactory<T>(val mapper: (List<io.damo.dropwizard.cloudfoundry.configs.VcapService>) -> (T), val getenv: (String) -> String? = System::getenv) : ConfigurationFactoryFactory<T> {
